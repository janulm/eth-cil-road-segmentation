...
flags.DEFINE_string(
    "base_dir", "submissions/sam/cnn_decoder/", "The directory with the predicted masks.")
...
def mask_to_submission_strings(image_filename, mask_dir=None, foreground_threshold = 0.25):
...
def masks_to_submission(submission_filename, mask_dir, *image_filenames, foreground_threshold= 0.25):
...
def make_submission(submission_filename, base_dir, foreground_threshold=0.25):
